#!/usr/bin/env bash
# Git Cleanup unified deletion script
# Receives JSON arrays of items to delete, executes deletion by category
# Parameters: --worktrees <JSON array> --branches <JSON array> --tags <JSON array>
set -euo pipefail
