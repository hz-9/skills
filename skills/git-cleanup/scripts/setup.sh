#!/usr/bin/env bash
# Git Cleanup environment setup script
# Combined: main branch detection + identify current Worktree/branch + backup creation
...
# Identify current Worktree and checked-out branch
identify_worktree() {
  local current_wt
