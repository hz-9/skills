...
# 检测 Prisma 版本
grep "@prisma/client" package.json | sed 's/.*"\([0-9\.]*\)".*/Prisma version: \1/'

test -f prisma/schema.prisma && echo "Prisma Schema found"
test -f prisma.config.ts && echo "Prisma 7 config found"
...
test -f prisma/schema.prisma && echo "✓ Prisma Schema"
